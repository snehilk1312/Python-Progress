...
a 6246 difficult 2286 data 9259 analysis problem to having fun to helping
 9692 someone else solve a problem.  This book assumes that 
...
as 4839 our 9128 personal 4300 assistants who can take care of many things
...
many 3200 times 1562 the 5042 word is used.  While you were able to read
...
6985 the most used word was used is very easy for the 78
2582 computer:
...
for you to do the 
2036 things that you are uniquely suited for.  You bring 
creativity, intuition, and inventiveness to this
partnership.  

8540 Creativity and motivation

9025 While this book is not intended for professional programmers, professional 5705
...
5985 instead for us to be more productive in handling the data and 
...
4243 with what is next?  If your computer is rated
...
6634 Secondary Memory.

While 2026 most 3589 of 940 the detail of how these components work is best left 
...
3462 down to five mm  tall and insert you into the computer just so you 
...
7560 of writing these instructions down and getting the instructions to 3813
...
7998 you need to know the vocabulary and the grammar.  You need to be able 2830
...
1954 When we train a dog, we use special words like
sit, stay, and fetch.  When you talk to a dog and
don't 8670 use 9610 any 5116 of the reserved words, they just look at you with a 
...
5852 When you say try, Python will try every time you say it without
fail.

We will learn these reserved words and how they are used in good time,
8683 but for now we will focus on the Python equivalent of speak (in 2226
...
9050 not intelligent.  You are really just having a conversation 7867
with yourself, but using proper syntax.

In a sense, when you use a program written by someone else
8332 the conversation is between you and those other
...
4169 Machine language seems quite simple on the surface, given that there 
...
You 9525 can 2463 look 398 at the actual source code for the Python interpreter by
...
6043 which is called a script.  By
convention, Python scripts have names that end with .py.

script

To execute the script, you have to tell the Python interpreter 
the 771 name 4612 of 4345 the file.  In a Unix or Windows command window, 
 1931 you would type python hello.py as follows: 7771

We call the Python interpreter and tell it to read its source code from
the file hello.py instead of prompting us for lines of Python code
2512 interactively. 8668
...
import re
s=0
hand=open('regex_sum_304664.txt')
k=re.findall('([0-9]+)',hand.read())
for j in k:
    s+=int(j)
#print(len(k))
print(s)
